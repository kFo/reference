...
copyright = '2017, Jeremy Avigad, Gabriel Ebner, Sebastian Ullrich'
author = 'Jeremy Avigad, Gabriel Ebner, Sebastian Ullrich'
...
html_theme_options = {
   ...
   'code_bg': 'white',
   # 'code_font_family': 'Courier New, Courier, monospace',
   'code_font_family': 'Lucida Console, Monaco, monospace',
...
htmlhelp_basename = 'lean_reference'
...
latex_documents = [
    (master_doc, 'lean_reference.tex', 'The Lean Reference Manual',
...
man_pages = [
    (master_doc, 'lean_reference', 'The Lean Reference Manual',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'lean_reference', 'The Lean Reference Manual',
     author, 'lean_reference', 'Reference for the Lean Theorem Prover.',
     'Miscellaneous'),
]
